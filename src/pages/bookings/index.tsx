...
export function BookingListPage(props: BookingListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('seat', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'seat',
          header: 'Seat',
          accessorKey: 'seat',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/seats/view/${record.seat?.id}`}>
              {record.seat?.availability}
            </Link>
          ),
        }
      : null,
